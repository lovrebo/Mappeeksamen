...
bibliography: bibliografi_5.bib
---
...
Styrketrening har gjennom tida blitt eit vanleg fenomen i kvardagen til mange menneske. [@Kraemer] definerte styrketrening som eit generelt omgrep som viser til trening der ein må utøve kraft mot ei motstand, og har vist seg å vere ein særs effektiv metode for å auke muskelstyrke, lokal muskeluthald, kraft, hypertrofi og motorisk yteevne.
[@Ost] og [@Cannon] har funnet at det er liten variasjon i responsen på maksstyrke og mager masse ved lavt og høyt treningsvolum. [@Galvao], [@Humburg] og [@McBirde] konkluderte mostridande til det då dei såg ein forbetring av høgare volum.  
